...
import { Badge, Playground, TutorialBadge } from '@site/components'
...
export const version = (version = 1) => new Elysia()
        .get('/version', version)
...
export const plugin3 = (config) => new Elysia({
        name: 'my-plugin',
        seed: config,
    })
...
export const _demo1 = new Elysia()
    .post('/student', 'Rikuhachima Aru')

export const _plugin2 = new Elysia()
    .onBeforeHandle({ as: 'global' }, () => {
        return 'hi'
    })
    .get('/child', () => 'child')

export const _demo2 = new Elysia()
    .use(plugin2)
    .get('/parent', () => 'parent')
...
export const _plugin3 = new Elysia()
    .onBeforeHandle({ as: 'global' }, () => {
        return 'overwrite'
    })

export const _demo3 = new Elysia()
    .guard(app => app
        .use(plugin3)
        .get('/inner', () => 'inner')
    )
