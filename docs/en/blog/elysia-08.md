...
The documentation of [Macro API](/en/patterns/macro) is now available in **pattern** section.
...
A "safe" version of [derive](/en/essential/context.html#derive).
...
We are now trying to provide more support for each runtime, plugin, and integration to return the kindness you have given us, starting with the rewrite of the documentation with more detailed and beginner-friendliness, [Integration with Nextjs](/en/integrations/nextj), [Astro](/en/integrations/astro) and more to come in the future.
