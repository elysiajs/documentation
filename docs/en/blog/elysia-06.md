...
const group = (app: Elysia) =>
    app.group('/v1', (app) => app.get('/hello', () => 'Hello World'))

// >= 0.6
const group = new Elysia({ prefix: '/v1' }).get('/hello', () => 'Hello World')
```
...
new Elysia().mount(A).mount(B).mount(C)
```
...
![Elysia life-cycle diagram](/en/blog/elysia-06/lifecycle-05.webp)
...
> ![Elysia life-cycle diagram with onResponse hook](/en/blog/elysia-06/lifecycle-06.webp)
