...
For example, you can generate documentation with Swagger only in 1 line using [Swagger plugin](/en/plugins/swagger).
...
Or when you want to use [GraphQL Apollo](/en/plugins/graphql-apollo) on Bun.
