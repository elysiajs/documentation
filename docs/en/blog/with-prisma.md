...
If you're looking for a place to start learning about out Bun, consider take a look for what Elysia can offer especially with an [end-to-end type safety](/en/eden/overview) like tRPC but built on REST standard without any code generation.
