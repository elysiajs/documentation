...
new Elysia()
    ...
    .model(
        ...
        Type.TemplateLiteral([
            Type.Literal('Elysia '),
            Type.Union([Type.Literal('The Blessing'), Type.Literal('Radiant')])
        ])
    )
...
You can find more detail at the [explicit body](/en/concept/explicit-body) page in concept.
...
You can find more detail at [numeric type](/en/concept/numeric) page in concept.
