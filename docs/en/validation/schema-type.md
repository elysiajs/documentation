...
![URL Object](/en/essential/url-object.svg)
...
For detail explaination, see [path](/en/new/essential/path), but to summarize.
...
![Path Parameters](/en/essential/path-parameter.webp)
