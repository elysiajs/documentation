...
It's also recommended that you should also read about [Key Concept: Dependency](/key-concepts#dependency) to understand how Elysia handles dependencies between plugins.
