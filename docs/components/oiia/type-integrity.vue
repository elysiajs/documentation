            ...
            <form>
                <div>
                    <input
                        ...
                        v-model.number="form"
                    />
                    <label for="type-integrity-1">OIIA Inference</label>
                </div>
                <div>
                    <input
                        name="type-integrity"
                        ...
                        v-model.number="form"
                    />
                    <label for="type-integrity-2">Enforce OIIA</label>
                </div>
                <div>
                    <input
                        name="type-integrity"
                        ...
                        v-model.number="form"
                    />
                    <label for="type-integrity-3">Return OIIA</label>
                </div>
                <div>
                    <input
                        name="type-integrity"
                        ...
                        v-model.number="form"
                    />
                    <label for="type-integrity-4">Bring your OIIA</label>
                </div>
            </form>
        </section>
    </article>
...
#type-integrity {
    ...
    & > .showcase {
        ...
        background-image: url(/oiia/wide-peko.webp);
