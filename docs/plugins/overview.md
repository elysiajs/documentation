...
-   [LogLayer](https://loglayer.dev/integrations/elysia.html) - integrates [LogLayer](https://loglayer.dev), which is a logging abstraction that supports popular logging libaries and cloud sevices
