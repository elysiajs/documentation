...
-   [LogLayer](https://loglayer.dev/integrations/elysia.html) - integrates [LogLayer](htts://loglayer.dev), which is a logging abstraction that supports popular logging libaries and cloud sevices
