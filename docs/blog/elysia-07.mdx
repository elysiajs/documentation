...
import { Blog } from '@site/components'
...
<figure class="flex flex-row w-full max-w-full">
    <img alt="Elysia 0.6" style={{ width: '50%', background: 'transparent', boxShadow: 'unset' }} className="object-contain" src="/blog/elysia-07/type-0-6.webp" />
    <img alt="Elysia 0.7" style={{ width: '50%', background: 'transparent', boxShadow: 'unset' }} className="object-contain" src="/blog/elysia-07/type-0-7.webp" />
</figure>
