...
1. `Elysia.file`, and [Static Plugin](/plugins/static) doesn't work `does not support file system access`.
2. [OpenAPI Type Gen](/blog/openapi-type-gen) doesn't work due to the lack of `fs` module.
