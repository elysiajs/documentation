...
Elysia adopts many standards by default, like OpenAPI and WinterTC compliance, allowing you to integrate with most industry-standard tools or at least easily integrate with tools you are familiar with.
