...
export default function WhatIsElysia() {
    ...
    return (
        ...
        >
            <h2
                className="flex flex-col md:flex-row justify-center items-start md:items-end gap-4 w-full text-5xl leading-tight font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-purple-400 mb-8"
                style={{
                    opacity: inView ? 1 : 0,
            ...
            <section className="flex flex-col sm:flex-row items-strech gap-4 md:gap-6 w-full max-w-6xl">
                <article
                    className="md:aspect-1 w-full rounded-xl border"
                    style={{
                        opacity: inView ? 1 : 0,
                        transform: inView
                            ? `translateX(0)`
                ...
                <article
                    className="md:aspect-1 w-full rounded-xl border overflow-hidden"
                    style={{
                        opacity: inView ? 1 : 0,
                        transform: inView
                            ? `translateX(0)`
            ...
            <p
                className="text-xl text-center leading-relaxed text-gray-400 mt-8"
                style={{
                    opacity: inView ? 1 : 0,
                    transform: inView ? `translateX(0)` : `translateX(-1em)`,
                    transition:
