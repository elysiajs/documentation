<template>
    <section class="flex flex-col w-full max-w-6xl mx-auto mt-8 mb-8">
        <h2
        ...
        >
            Elysia is
            <b class="text-gray-500">not backed by organizations</b>
            <br />
            Made possible by the support of the community and
            <span
                class="text-pink-400 font-medium underline"
        ...
        <ul id="sponsors" v-if="sponsors.length > 0" class="my-8">
            <li v-for="sponsor in sponsors" :key="sponsor.sponsorEntity.login">
                ...
                >
                    ...
                    <p
                        className="text-xs text-gray-500 dark:text-gray-400 my-0"
                    >
                        {{
                            dayjs()
